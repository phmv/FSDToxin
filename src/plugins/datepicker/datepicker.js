  ...
  (function () {
    var VERSION = "2.2.3",
      ...
      defaults = {
        ...
        prevHtml: '<i class="datepicker--arrow material-icons">arrow_back</i>',
        nextHtml: '<i class="datepicker--arrow material-icons">arrow_forward</i>',
        navTitles: {
          days: "MM yyyy",
          months: "yyyy",
          years: "yyyy1 - yyyy2",
      ...
      this.dateOutOfBounds = function (date) {
        if (this.opts.twoInputsIdDiff) {
          if (this.selectedDates.length == 2) {
            if ((this.targetInputIndex == 1 && datepicker.less(this.minRange, date)) || (this.targetInputIndex == 0 && datepicker.bigger(this.maxRange, date))) {
              return true;
            } else {
              return false;
            }
          } else if (this.selectedDates.length == 1) {
            if ((this.targetInputIndex == 1 && datepicker.bigger(date, this.selectedDates[0])) || (this.targetInputIndex == 0 && datepicker.less(date, this.selectedDates[0]))) {
              return true;
            } else {
              return false;
            }
    ...
    datepicker.prototype = {
      ...
      _onShowEvent: function (e) {
        if (!this.visible) {
          ...
          if (this.opts.twoInputsIdDiff) {
            this.targetInputIndex = this.inputs.findIndex((input) => input.attr("id") === this.target.id);
          }
          this.show();
  ...
  (function () {
    ...
    datepicker.Body.prototype = {
      ...
      _getDayNamesHtml: function (firstDay, curDay, html, i) {
        ...
        html += '<div class="datepicker--day-name' + (this.d.isWeekend(curDay) ? " -weekend-" : "") + '">' + '<span class="datepicker--cellcontainer">' + this.d.loc.daysMin[curDay] + "</span>" + "</div>";
      ...
      _getCellContents: function (date, type) {
        ...
        if (opts.range) {
          ...
          if (parent.selectedDates.length == 1 && parent.focused) {
            if ((dp.bigger(minRange, date, type) && dp.less(parent.focused, date, type)) || (dp.less(maxRange, date, type) && dp.bigger(parent.focused, date, type))) {
              classes += " -in-range-";
            }
      ...
      _getDayHtml: function (date) {
        ...
        return (
          ...
          date.getFullYear() +
          '">' +
          '<span class="datepicker--cellcontainer">' +
          content.html +
          "</span>" +
          "</div>"
        );
      ...
      _getMonthHtml: function (date) {
        ...
        return '<div class="' + content.classes + '" data-month="' + date.getMonth() + '">' + `<span class="datepicker--cellcontainer">` + content.html + "</span>" + "</div>";
      },
